 ...
 */
	...
	public int getValorDoidao(){

		return (this.getAtualizacaoPlano() * 1000) + this.getID();
 ...
 */
	...
	public void inserir(Municipio municipio, int posicao) throws Exception{
		...
		municipios[posicao] = municipio.clone();
		n++;
 ...
 */
	...
	public Municipio removerInicio() throws Exception{
		...
		Municipio tmp = municipios[0].clone();
		n--;
 ...
 */
	...
	public Municipio remover(int posicao) throws Exception{
		...
		Municipio tmp = municipios[posicao].clone();
		n--;
 ...
 */
	...
	public void radixSort(){
		...
		ListaMunicipios n0 = new ListaMunicipios();
	
		ListaMunicipios n1 = new ListaMunicipios();
	
		ListaMunicipios n2 = new ListaMunicipios();

		ListaMunicipios n3 = new ListaMunicipios();

		ListaMunicipios n4 = new ListaMunicipios();

		ListaMunicipios n5 = new ListaMunicipios();

		ListaMunicipios n6 = new ListaMunicipios();

		ListaMunicipios n7 = new ListaMunicipios();

		ListaMunicipios n8 = new ListaMunicipios();

		ListaMunicipios n9 = new ListaMunicipios();

		for(k = 0; k < 7; k++){

			for(i = 0; i < this.n; i++){

				tmp = municipios[i].getValorDoidao() % (int)Math.pow(10, (k+1));

				tmp = tmp / (int)Math.pow(10, k);

				switch(tmp){

					case (0):

						n0.inserirFim(municipios[i].clone());

						break;

					case (1):

						n1.inserirFim(municipios[i].clone());

						break;
					
					case (2):

						n2.inserirFim(municipios[i].clone());

						break;
						
					case (3):

						n3.inserirFim(municipios[i].clone());

						break;

					case (4):

						n4.inserirFim(municipios[i].clone());

						break;

					case (5):

						n5.inserirFim(municipios[i].clone());

						break;

					case (6):

						n6.inserirFim(municipios[i].clone());

						break;

					case (7):

						n7.inserirFim(municipios[i].clone());

						break;

					case (8):

						n8.inserirFim(municipios[i].clone());

						break;

					case (9):

						n9.inserirFim(municipios[i].clone());
			...
			while(l < n0.n){
				...
				municipios[j] = n0.municipios[l].clone();
			...
			n0 = new ListaMunicipios();

			l = 0;

			while(l < n1.n){

				municipios[j] = n1.municipios[l].clone();
			...
			n1 = new ListaMunicipios();

			l = 0;

			while(l < n2.n){

				municipios[j] = n2.municipios[l].clone();
			...
			n2 = new ListaMunicipios();

			l = 0;

			while(l < n3.n){

				municipios[j] = n3.municipios[l].clone();
			...
			n3 = new ListaMunicipios();

			l = 0;

			while(l < n4.n){

				municipios[j] = n4.municipios[l].clone();
			...
			n4 = new ListaMunicipios();

			l = 0;

			while(l < n5.n){

				municipios[j] = n5.municipios[l].clone();
			...
			n5 = new ListaMunicipios();

			l = 0;

			while(l < n6.n){

				municipios[j] = n6.municipios[l].clone();
			...
			n6 = new ListaMunicipios();

			l = 0;

			while(l < n7.n){

				municipios[j] = n7.municipios[l].clone();
			...
			n7 = new ListaMunicipios();

			l = 0;

			while(l < n8.n){

				municipios[j] = n8.municipios[l].clone();
			...
			n8 = new ListaMunicipios();

			l = 0;

			while(l < n9.n){

				municipios[j] = n9.municipios[l].clone();
...
class TP05Q12{
	...
	public static void main(String[] args){
		...
		Arq.openWrite("572251_radixsort.txt", "utf-8");

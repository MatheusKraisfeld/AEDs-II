 ...
 */
	...
	public void mostrar() throws Exception{
		...
		for(Municipio i = primeiro.prox; i != ultimo.prox; i = i.prox){
	...
	public int tamanho(){
		...
		for(Municipio j = primeiro.prox; j != null; cont++, j = j.prox);
			...
			switch (tmp[0]) {
				...
				case "II":
					...
					try{
						...
						list.inserirInicio(city[Integer.parseInt(tmp[1])]);
				...
				case "I*":
					...
					try{		
						...
						list.inserir(city[Integer.parseInt(tmp[2])], Integer.parseInt(tmp[1]));
				...
				case "IF":
					...
					try{
						...
						list.inserirFim(city[Integer.parseInt(tmp[1])]);

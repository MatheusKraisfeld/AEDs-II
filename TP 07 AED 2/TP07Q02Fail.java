...
class No{
	...
	No(int elemento){
		...
		this.esq = this.dir = this.outro = null;
...
class ArvoreArvore {
     ...
     * <code>false</code> em caso contrario.
     */
    public void pesquisarPrimeira(int elemento) {
     ...
     * @param i No em analise.
     */
    private void mostrarCentral(No raiz, int elemento) {
        if (raiz != null) {
            mostrarCentral(raiz.esq); // Elementos da esquerda.
            raiz.outro.pesquisar
            mostrarCentral(raiz.dir); // Elementos da direita.
        }
    }
  
    public void pesquisarSegunda(int x) {
	MyIO.print("raiz ");
        return pesquisarSegunda(x, raiz);
    }
     ...
     * <code>false</code> em caso contrario.
     */
    private void pesquisarSegunda(int x, Municipio i) {
      boolean resp;
        if (i == null) {
	 MyIO.println("NAO");
         resp = false;
	 ...
	 MyIO.print("esq ");
         resp = pesquisarSegunda(x, i.esq);
 
      } else {
	 MyIO.print("dir ");
         resp = pesquisarSegunda(x, i.dir);
      }
      return resp;
    }
